...
Original file is located at
    https://colab.research.google.com/drive/131P3y5QJ5_pSIXIgJlmZ0IYYhuCf1SqW
"""
...
f = open("/content/drive/MyDrive/dataMachinelearning/dialogs.txt", "r")
print(f.read())
# reading the data

df=pd.read_csv('/content/drive/MyDrive/dataMachinelearning/dialogs.txt',names=('Query','Response'),sep=('\t'))
# Reading the data
...
df.shape
# There are 3725 rows and 2 columns in our dataset
